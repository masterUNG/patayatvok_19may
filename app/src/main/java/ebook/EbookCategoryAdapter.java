...
public class EbookCategoryAdapter extends ArrayAdapter<EbookData> {

	private Context context;
	private ArrayList<EbookData> arrData;
	...
	public EbookCategoryAdapter(Context context, int resource,
			ArrayList<EbookData> arrData) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (arrData != null) {
			holder.txtName.setText(arrData.get(position).getName());
			imageLoader.displayImage(arrData.get(position).getImgs(),
